...
class PlatformProvider extends OrchidServiceProvider
{
    ...
    {
        return [
            Menu::make('Secteur activité')
                ->icon('list')
                ->route('platform.secteur.list')
                ->title('Secteur'),

            Menu::make('Sous-secteur')
                ->icon('list')
                ->route('platform.sous-secteur.list'),

            Menu::make('Liste de Genre')
                ->icon('list')
                ->route('platform.genre.list')
                ->title('Genre'),

            Menu::make('Liste de Type Job')
                ->icon('list')
                ->route('platform.typejob.list')
                ->title('Type de Job'),

            Menu::make('Liste de Candidature')
                ->icon('list')
