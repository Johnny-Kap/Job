                    ...
                    <div class="candidate-list bg-light">
                        ...
                        <div class="widget ms-auto mb-0">
                            <div class="company-detail-meta ms-auto">
                                <a class="btn btn-primary" href="{{route('entreprise.jobs.manage')}}">Gérer mes emplois <i class="far fa-edit"></i></a>
                                <a class="btn btn-primary" href="{{route('entreprise.setting')}}">Mettre à jour <i class="fas fa-cog ms-1"></i></a>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="job-list">
                                        ...
                                        <div class="job-list-details">
                                            <div class="job-list-info">
                                                <div class="job-list-title">
                                                    <h5 class="mb-0"><a href="job-detail.html">{{$item->titre}}</a></h5>
                                                </div>
                                        ...
                                        <div class="job-list-favourite-time"> <span
                                                class="job-list-time order-1"><i class="far fa-clock pe-1"></i>{{$item->dateline}}</span>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
