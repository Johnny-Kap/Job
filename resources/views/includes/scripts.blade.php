<<<<<<< HEAD
  ...
  {{-- <script src="../libraries/js/other/jquery-3.4.1.min.js"></script> --}}
  {{-- <script src="../libraries/js/other/bootstrap.bundle.min.js"></script>
 <script src="../libraries/js/other/owl.carousel.min.js"></script> --}}
  <script src="/../libraries/js/other/jquery-te-1.4.0.min.js"></script>
  {{-- <script src="../libraries/js/other/upvote.vanilla.js"></script>
<script src="../libraries/js/other/upvote-script.js"></script>
