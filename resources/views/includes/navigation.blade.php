            ...
            <div class="navbar-collapse collapse justify-content-start">
                <ul class="nav navbar-nav">
                    <li class="nav-item dropdown active">
                        <a class="nav-link" href="{{url('/')}}" id="navbarDropdown">Accueil</a>
                    </li>
                    ...
                    <div class="login d-inline-block pl-4">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{route('candidat.my-profil')}}">Voir profil</a></li>
                                    <li><a class="dropdown-item" href="{{route('candidat.gestion-emplois')}}">Mes emplois</a></li>
                                    <li><a class="dropdown-item" href="{{route('candidat.my-setting')}}">Paramètres</a></li>
