...
Route::post('resume/education/update/{id}', [App\Http\Controllers\EducationController::class, 'update'])->name('candidat.resume.educ.update');
Route::post('resume/education/supp/{id}', [App\Http\Controllers\EducationController::class, 'destroy'])->name('candidat.resume.educ.supp');
...
Route::post('resume/information/supp/{id}', [App\Http\Controllers\InformationController::class, 'destroy'])->name('candidat.resume.info.supp');
...
Route::post('resume/experience/supp/{id}', [App\Http\Controllers\ExperienceController::class, 'destroy'])->name('candidat.resume.expe.supp');
...
Route::post('resume/competence/supp/{id}', [App\Http\Controllers\CompetenceController::class, 'destroy'])->name('candidat.resume.compe.supp');
...
Route::post('resume/langue/supp/{id}', [App\Http\Controllers\LangueController::class, 'destroy'])->name('candidat.resume.lang.supp');
